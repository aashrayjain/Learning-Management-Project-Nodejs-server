...
//         var sql = "CREATE TABLE USER(USER_ID INT NOT NULL, USERNAME VARCHAR(255) NOT NULL, CREATION_DATE DATE, COURSE_ID INT, PASSWORD VARCHAR(255) NOT NULL, USER_TYPE VARCHAR(255) NOT NULL,PRIMARY KEY (USER_ID), CONSTRAINT FK_CourseUser FOREIGN KEY (COURSE_ID) REFERENCES COURSE(COURSE_ID))";
